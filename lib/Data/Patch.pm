...
Data::Patch - Compute and apply JSONPatch compatible deltas

=head1 VERSION

This document describes Data::Patch version 0.01
...
sub _at_path {
  ...
  croak "Patch refers to a non-existant path"
...
Data::Patch requires no configuration files or environment variables.
